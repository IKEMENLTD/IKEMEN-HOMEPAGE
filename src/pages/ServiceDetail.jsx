    ...
    const services = {
        ...
        'system-development': {
            ...
            products: [
                {
                    name: "LiteWEB+",
                    tagline: "初回たったの1万円から始めるWeb制作",
                    desc: "初回たったの1万円から始められるフルスクラッチWebサイト制作。テンプレートではなく、一からオリジナルで開発。中小企業・個人事業主のWeb集客を強力にサポートします。",
                    features: ["初回1万円〜", "フルスクラッチ開発", "レスポンシブ対応", "SEO最適化済み"],
                    url: "https://litewebplus.com/"
                },
                {
                    name: "TaskMate AI",
                    tagline: "月々1万円でCIOを内製化",
                    desc: "月々たったの1万円でCIOを内製化。AIが経営課題を分析し、最適なIT戦略を提案。さらに月々5万円からシステム開発の受託も可能。納期で柔軟に調整します。",
                    features: ["月額1万円〜", "CIO内製化", "システム開発月5万円〜", "納期柔軟対応"],
                    url: "https://taskmateai.net/",
                    noPreview: true
                },
                {
                    name: "SEO TURBO",
                    tagline: "スプレッドシート入力だけでSEO記事を自動生成",
